...
BEGIN {
    ...
    require '/home/dscrimie/Documents/University/Cybersecurity/HOMEWORK/hw02/openssl-3.3.1/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/dscrimie/Documents/University/Cybersecurity/HOMEWORK/hw02/openssl-3.3.1/test/fips-and-base.cnf';
    shift;
